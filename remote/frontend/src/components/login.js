...
import { Grid, Stack, Button, IconButton, Input } from "@mui/material";
import "./login.css";
...
export default function Login() {
  ...
  return (
    <Grid container className="login-container">
      <Grid className="login-form" sx={{display: "flex", flexDirection:"column", justifyContent: "center", padding: "50px"}}>
        <Stack>
